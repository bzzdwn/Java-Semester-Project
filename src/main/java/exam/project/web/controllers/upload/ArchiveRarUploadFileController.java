...
@Controller
// Class
public class ArchiveRarUploadFileController {

    @GetMapping("archive/archive/rar/upload") public String upload()
    {
        return "fileform";
    }

    @RequestMapping(value = "archive/archive/rar/uploadfile",
               ...
               Model mod)
    {
        ...
        try {
            ...
            try {
                rarArchivator.archive(filePath, filePath);
            } catch (IOException e) {
            ...
            FileDownloadController.setPath(filename + ".rar");
        }
