...
@Controller
// Class
public class XmlUploadFileController {

    @GetMapping("read/xml/upload") public String upload()
    {
        return "fileform";
    }

    @RequestMapping(value = "read/xml/uploadfile",
               ...
               Model mod)
    {
        ...
        try {
            ...
            while (matcher.find()) {
                newFile = matcher.group(1) + "\\" + matcher.group(2) + ".xml";
                newFile2 = matcher.group(2) + ".xml";
            }
