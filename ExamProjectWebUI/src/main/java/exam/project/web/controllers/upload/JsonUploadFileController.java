...
@Controller
// Class
public class JsonUploadFileController {

    @GetMapping("read/json/upload") public String upload()
    {
        return "fileform";
    }

    @RequestMapping(value = "read/json/uploadfile",
               ...
               Model mod)
    {
        ...
        try {
            ...
            while (matcher.find()) {
                newFile = matcher.group(1) + "\\" + matcher.group(2) + ".json";
                newFile2 = matcher.group(2) + ".json";
            }
